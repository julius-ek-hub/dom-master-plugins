...
import $, { _string, _object} from '../lib.js';
...
const _window = (content = '', props) => {
    ...
    let { border, height, width, title, fill, className, themeColor, theme, movable = true, resizable = true, x: _x_, y: _y_ } = _object(props);
    ...
    let header = __([df, 'header']).addChild([buttonGroup, titleBar]).style({ height: '40px', background: themeColor, borderBottom: border });
